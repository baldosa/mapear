...
# plot
ax = df[df['id']=='94'].plot(column=content['datos'],
             cmap=cmap_colors,
             figsize=(30, 13),
             edgecolor="grey",
             linewidth=0.4,
...
background.paste(foreground, (260, 525), foreground)
background.show()

#%%
max([float(i) for i in content['classification']])
